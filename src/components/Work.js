...
documents, market research and, IT support.</li>
        ...
        <div className="work-section">
          ...
          <div className="work-desc">
          <ul>
            <li>Heavy focus on Customer Service, where communication skills were key. Advising customers on
style and sizing, along with being efficient when retrieving deliveries from the stockroom.</li>
<li>Fastest till user during the sale, which required me to find the most efficient way to process
transactions while maintaining interaction with customers.</li>
<li>Worked in a team where roles were delegated at the start of the day, adapting during peak hours to
ensure customer service was a priority. The ability to multitask was important.</li>
          </ul>
        </div>
        </div>
